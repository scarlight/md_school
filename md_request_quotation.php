...
<div class="left-form">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="quantity" name="md-in-quantity" placeholder="" value="<?php if (isset($_POST['md-in-quantity'])) echo esc_attr($_POST['md-in-quantity']); ?>" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="product-color" name="md-in-product-color" value="<?php if (isset($_POST['md-in-product-color'])) echo esc_attr($_POST['md-in-product-color']); ?>">
    </div>
    <div class="form-group">
        ...
        <div class="classification">
            <label for="logo-front-color" class="control-label" style="margin-top:5px; width:74px; font-style:italic;">No. of color</label>
            <input type="text" class="form-control floatr" id="logo-front-color" name="md-in-logo-front-color" value="<?php if (isset($_POST['md-in-logo-front-color'])) echo esc_attr($_POST['md-in-logo-front-color']); ?>" style="width:190px; margin-right:2px;">
    ...
    <div class="form-group">
        ...
        <div class="classification">
            <label for="logo-back-color" class="control-label" style="margin-top:5px; width:74px; font-style:italic;">No. of color</label>
            <input type="text" class="form-control floatr" id="logo-back-color" name="md-in-logo-back-color" value="<?php if (isset($_POST['md-in-logo-back-color'])) echo esc_attr($_POST['md-in-logo-back-color']); ?>" style="width:190px; margin-right:2px;">
    ...
    <div class="form-group fileinput fileinput-new" data-provides="fileinput">
        ...
        <div class="input-group">
            ...
            <span class="input-group-addon btn btn-default btn-file">
                ...
                <input type="file" name="md-in-artwork" id="artwork">
            </span>
    ...
    <div class="form-group">
        ...
        <div class="classification">
            <label for="print-packaging-color" class="control-label"style="margin-top:5px; width:74px; font-style:italic;">No. of color</label>
            <input type="text" class="form-control floatr" id="print-packaging-color" name="md-in-print-packaging-color" value="<?php if (isset($_POST['md-in-packaging-color'])) echo esc_attr($_POST['md-in-packaging-color']) ?>" style="width:190px; margin-right:2px;">
            <div class="clear"></div>
        </div>
    </div>
    <div class="form-group">
        <label for="budget" class="control-label">Budget <i>(if any)</i></label>
        <input type="text" class="form-control" id="budget" name="md-in-budget" value="<?php if (isset($_POST['md-in-budget'])) echo esc_attr($_POST['md-in-budget']) ?>">
    </div>
    <div class="form-group">
        <label for="deadline" class="control-label">Deadline <i>(if any)</i></label>
        <input type="text" class="form-control datepicker" id="deadline" name="md-in-deadline" value"<?php if (isset($_POST['md-in-deadline'])) echo esc_attr($_POST['md-in-deadline']); ?>">
    </div>
    <div class="form-group">
        <label for="other-requirement" class="control-label aligntop">Other Requirement</label>
        <textarea class="form-control textarea" name="md-in-other-requirement" id="other-requirement" cols="3" rows="4" placeholder="Please write here for further inquiry, information or important details. Example : Request a USB 3.0 pircing specify pantone color code in your logo, etc." value="<?php if (isset($_POST['md-in-other-requirement'])) echo esc_attr($_POST['md-in-other-requirement']) ?>"></textarea>
    </div>
</div>
...
<?php if (!is_user_logged_in()) { ?>
    <div class="right-form">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" name="user_login" placeholder="First and Last Name" value="<?php if (isset($_POST['user_login'])) echo esc_attr($_POST['user_login']) ?>" required>
        </div>
        <div class="form-group">
            <label for="email" class="control-label">Email Address <span class="required">*</span></label>
            <input type="email" class="form-control" id="email" name="user_email" placeholder="abc@gmail.com" value="<?php if (isset($_POST['user_email'])) echo esc_attr($_POST['user_email']) ?>" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="companyname" name="md-in-companyname" placeholder="Name of Your Company" value="<?php if (isset($_POST['md-in-companyname'])) echo esc_attr($_POST['md-in-companyname']) ?>" required>
        </div>
        <div class="form-group">
            <label for="registration-no" class="control-label">Co / Bis Reg. no.</label>
            <input type="text" class="form-control" id="registration-no" name="md-in-registration-no" value="<?php if (isset($_POST['md-in-registration-no'])) echo esc_attr($_POST['md-in-registration-no']) ?>">
        </div>
        <div class="form-group">
            <label for="mobile" class="control-label">Mobile <span class="required">*</span></label>
            <input type="text" class="form-control" id="mobile" name="md-in-mobile" placeholder="e.g. 601X XXXXXXX" value="<?php if (isset($_POST['md-in-mobile'])) echo esc_attr($_POST['md-in-mobile']) ?>" required>
        </div>
        <div class="form-group">
            <label for="tel" class="control-label">Tel</label>
            <input type="text" class="form-control" id="tel" name="md-in-telephone" placeholder="e.g. 601X XXXXXXX" value="<?php if (isset($_POST['md-in-telephone'])) echo esc_attr($_POST['md-in-telephone']) ?>">
        </div>
        <div class="form-group">
            <label for="fax" class="control-label">Fax</label>
            <input type="text" class="form-control" id="fax" name="md-in-fax" placeholder="e.g. 601X XXXXXXX" value="<?php if (isset($_POST['md-in-fax'])) echo esc_attr($_POST['md-in-fax']) ?>">
        </div>
        <div class="form-group">
            <label for="address" class="control-label aligntop">Address <span class="required">*</span></label>
            <textarea class="form-control textarea" name="md-in-address" id="address" cols="30" rows="4" value="<?php if (isset($_POST['md-in-address'])) echo esc_attr($_POST['md-in-address']) ?>" required></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="classification">
                ...
                <input type="text" class="form-control floatr" id="others-desc" name="md-in-others-desc" value="<?php if (isset($_POST['md-in-others-desc'])) echo esc_attr($_POST['md-in-others-desc']) ?>" style="width:215px; margin-right:32px;">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control textarea" name="md-in-enquiry" id="enquiry" cols="3" value="<?php if (isset($_POST['md-in-enquiry'])) echo esc_attr($_POST['md-in-enquiry']) ?>" rows="4" required></textarea>
        </div>

        <div class="form-group">
            <label for="" class="control-label aligntop">Register to access Current Stock <br>Pricing <span class="required">*</span></label>
